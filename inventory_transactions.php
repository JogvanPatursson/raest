...
<div class="container">
	...
	<?php
	$sql = "SELECT transactions.transaction_id, user.user_name, transactions.item_type, transactions.transaction_type, transactions.transaction_date FROM transactions JOIN user ON transactions.user_id = user.user_id ORDER BY transaction_date DESC";
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			<tr>
			    ...
			    <td>
			        <a href="#update<?php echo $row['transaction_id']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
			        <a href="#delete<?php echo $row['transaction_id']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
